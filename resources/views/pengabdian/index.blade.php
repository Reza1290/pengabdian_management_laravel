    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Kelola Data Pengabdian</h4>
                <a href="{{ route('pengabdian.pembimbing.assign') }}" class="btn btn-primary">Tambah Pengabdian</a>
            </div>
            <div class="card-body">
                @if (session('success'))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('pengabdian.edit', $pengabdian->id) }}" class="btn btn-warning">Edit</a>
