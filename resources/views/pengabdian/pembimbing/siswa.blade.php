    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <input type="text" id="searchInput" class="form-control mt-2" placeholder="Cari Siswa...">
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody id="pembimbingTable">
                        ...
                        <tr>
                            ...
                            <td>{{ $p->jurusan }}</td>
                            <td>
                                <form action="{{ route('pengabdian.pembimbing.siswa.storeAssign', [$pembimbing, $p->id]) }}" method="POST">
                                    @csrf
